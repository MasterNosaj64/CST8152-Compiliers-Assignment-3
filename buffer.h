...
#define MULTI_MODE		'm'
#define FIXED_MODE		'f'
#define ADD_MODE_NUM	1
#define MULTI_MODE_NUM	-1
#define FIXED_MODE_NUM	0
#define MAXIMUM_BUFFER_CAPACITY (SHRT_MAX-1)

#define DEFAULT_FLAGS		0xFFFC		/* 1111 1111 1111 1100 */
#define SET_EOB				0x0002		/*0000 0000 0000 0010*/ /*use bitwise or operation*/
#define RESET_EOB			0xFFFD		/*1111 1111 1111 1101*/
#define CHECK_EOB			0x0002		/*0000 0000 0000 0010*/
#define SET_R_FLAG			0x0001		/*0000 0000 0000 0001*/ /*use bitwise or operator*/
